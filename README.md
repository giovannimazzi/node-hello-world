# Assegnazione del 26/02/2026

**node-hello-world**

nome repo: `node-hello-world`

**Esercizio**

> 1. Creiamo la prima applicazione con NodeJs e inizializziamola con `npm init`
> 2. Scriviamo un file `server.js` che dovrà stampare nel terminale “Hello World”. Proviamo ad eseguirlo dal terminale stesso usando i comandi di node base.
...
Bonus: Giocare con `process.argv` ricordateviche è un array
